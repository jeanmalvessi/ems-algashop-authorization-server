...
import com.algaworks.algashop.authorizationserver.application.user.query.AuthUserQueryApplicationService;
...
public class MyUserController {
    ...
    private final AuthUserQueryApplicationService queryService;
